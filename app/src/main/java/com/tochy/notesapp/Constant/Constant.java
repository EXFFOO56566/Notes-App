package com.tochy.notesapp.Constant;
...
public class Constant implements Serializable {
    ...
    public static String company = "Nemosofts";
    public static String email = "info.nemosofts@gmail.com";
    public static String website = "https://www.nemosoftscom/";
    public static String contact = "+00 020456089";
